...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('usuario', '0002_rename_id_usuario_clientefuncionario_id_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preco_produto', models.DecimalField(decimal_places=2, default=0.0, max_digits=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('total_lucro', models.DecimalField(decimal_places=2, default=0.0, max_digits=100)),
                ...
                ('id_usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='usuario.clientefuncionario')),
            ],
        ),
    ]
